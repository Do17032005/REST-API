...
public class ParkingController {
    ...
    public ResponseEntity<ApiResponse<List<TicketSummaryResponse>>> getTodayTicketSummaries() {
        List<TicketSummaryResponse> summaries = parkingService.getTodayTicketSummaries();
        return ResponseEntity.ok(new ApiResponse<>(true, "Retrieved ticket summaries successfully", summaries));
    }
}